                    ...
                    <tr>
                      <td colSpan={7} className="px-6 py-10 text-center text-slate-500 dark:text-slate-400">
                        {searchQuery || typeFilter || statusFilter ? (
                          <div>
                            <p className="font-medium mb-1">No content matches your filters</p>
                            <p className="text-sm">Try adjusting your search or filter criteria</p>
                          </div>
                        ) : (
                          <div>
                            <p className="font-medium mb-1">No content found</p>
                            <p className="text-sm">Get started by creating new content</p>
                          </div>
                        )}
                      </td>
                    </tr>
            ...
            >
              {searchQuery || typeFilter || statusFilter ? (
                <div>
                  ...
                  <p className="font-medium text-lg mb-1 text-slate-700 dark:text-slate-300">No content matches your filters</p>
                  <p className="text-slate-500 dark:text-slate-400">Try adjusting your search or filter criteria</p>
                </div>
              ) : (
                <div>
                  <FileQuestion size={48} className="text-slate-400 mx-auto mb-4" />
                  <p className="font-medium text-lg mb-1 text-slate-700 dark:text-slate-300">No content found</p>
                  <p className="text-slate-500 dark:text-slate-400">Get started by creating new content</p>
                </div>
              )}
            </motion.div>
          )}
